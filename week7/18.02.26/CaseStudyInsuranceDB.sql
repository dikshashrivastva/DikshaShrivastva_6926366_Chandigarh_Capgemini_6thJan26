...
dateofpayment date,amount decimal(10,2),
fine decimal(10,2)
);
...
select ps.policy_type_id , rf.policy_type_name , ps.descriptions 
from policy_sub_types ps 
join ref_policy_types rf 
on ps.policy_type_code=rf.policy_type_code 
...
select count(policy_type_code) as NO_OF_POLICIES , policy_type_code from ref_policy_types;
