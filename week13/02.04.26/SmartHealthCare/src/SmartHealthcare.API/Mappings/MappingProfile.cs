...
public class MappingProfile : Profile
{
    ...
    .ForMember(d => d.PatientName, opt => opt.MapFrom(s => s.Appointment.Patient.User.FullName))
    .ForMember(d => d.DoctorName,  opt => opt.MapFrom(s => s.Appointment.Doctor.User.FullName))
    .ForMember(d => d.AppointmentDate, opt => opt.MapFrom(s => s.Appointment.AppointmentDate));
